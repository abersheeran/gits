/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: d82d83654293a2f8c9824c59db4a6458)
// Runtime types generated with workerd@1.20260305.0 2026-02-28 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ActionsContainer" | "ActionsContainerBasic" | "ActionsContainerStandard1" | "ActionsContainerStandard2" | "ActionsContainerStandard3" | "ActionsContainerStandard4" | "RepositoryObject";
	}
	interface Env {
		GIT_BUCKET: R2Bucket;
		DB: D1Database;
		...
		APP_ORIGIN: string;
		JWT_SECRET: string;
		ACTIONS_REPOSITORY_ORIGIN: string;
		REPOSITORY_OBJECTS: DurableObjectNamespace<import("./src/index").RepositoryObject>;
		ACTIONS_RUNNER: DurableObjectNamespace<import("./src/index").ActionsContainer>;
		ACTIONS_RUNNER_BASIC: DurableObjectNamespace<import("./src/index").ActionsContainerBasic>;
		ACTIONS_RUNNER_STANDARD_1: DurableObjectNamespace<import("./src/index").ActionsContainerStandard1>;
		ACTIONS_RUNNER_STANDARD_2: DurableObjectNamespace<import("./src/index").ActionsContainerStandard2>;
		ACTIONS_RUNNER_STANDARD_3: DurableObjectNamespace<import("./src/index").ActionsContainerStandard3>;
		ACTIONS_RUNNER_STANDARD_4: DurableObjectNamespace<import("./src/index").ActionsContainerStandard4>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "JWT_SECRET" | "ACTIONS_REPOSITORY_ORIGIN">> {}
}
